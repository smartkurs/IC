...
function initShortQuestion() {
 qstHead[0]="3  Complete the sentences about the dialogue in exercise l. Use the affirma...";
 qstHead[1]="5 Complete the list of musical instru ments. The missing words are in the d...";
 qstHead[2]="6 Listen and identify the instruments  ";
 qstHead[3]="7      Dance,  play basketball, play football, play tennis,  play the drums...";
 qstHead[4]="8  Write a questionnaire about ability for your partner. Write six question...";
}
...
function Constructor() {
  valid = new init_array(0,0,0,0,0);
  nScore = new init_array(0,0,0,0,0);
  maxScore = new init_array(0,0,0,0,0);
  qstHead = new init_array("","","","","");
  qstRem = new init_array("","","","","");
  initShortQuestion();
  initQuestionRemark();
  groups = new init_array(0,0,0,0,0);
  pesi = new init_array(0,0,0,0,0);
  allAnsReport = new init_array(5);
  ordineDomande = new init_array(0,1,2,3,4);
  typeOfQuest = new init_array(4,4,4,4,3);
  isQuestCustom = new init_array(0,0,0,0,0);
  omitPoint = new init_array(0,0,0,0,0);
}
